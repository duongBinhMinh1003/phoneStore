  ...
  item.addEventListener("click", () => {
    ...
    <div class="content__container">
      <ul class="function__list">
        <li class="function__item" data-value="maNV">
          <label for="maNVl">Mã user:</label>
          <input type="text" id="maNV" placeholder="Nhập mã số " />
        </li>
        <li class="function__item" data-value="tenNV">
          <label for="tenNVl">Tên user:</label>
          <input type="text" id="tenNV" placeholder="Nhập họ tên" />
        </li>
        <li class="function__item" data-value="search">
          <button
            class="btn-search"
            style="
        ...
        <li class="function__item" data-value="newadd">
          <button
            class="btn-add"
            style="
              background: transparent;
        ...
        <div class="modal-content">
          ...
          <form id="form-admin">
            <div class="form-container">
              ...
              <div class="form-group">
                <label for="user-full_name" class="form-label"
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="customer">nv</option>
                  <option value="admin">ql</option>
                </select>
                <span class="form-message"></span>
              </div>
      ...
      <table id="product-table">
        ...
        <tbody class="product-table__list">
          <tr class="product-table__row product-table__row--clicked">
            ...
            <td>xxxxxx</td>
            <td>
              <button class="product-table__update-btn product-table-btn">
                Sửa
              </button>
              <button class="product-table__delete-btn product-table-btn">
                Xóa
              </button>
            </td>
          </tr>
    ...
    <div class="content__container">
      <ul class="function__list">
        <li class="function__item" data-value="maNV">
          <label for="maNVl">Mã số NV:</label>
          <input type="text" id="maNV" placeholder="Nhập mã số " />
        </li>
        <li class="function__item" data-value="tenNV">
          <label for="tenNVl">Tên NV:</label>
          <input type="text" id="tenNV" placeholder="Nhập họ tên" />
        </li>
        <li class="function__item" data-value="search">
          <button
      ...
      <div id="edit-modal" class="modal">
        <div class="modal-content">
          ...
          <form id="form-admin">
            <div class="form-container">
              <div class="form-group">
                <label for="user-id" class="form-label">Mã NV</label>
                <input
                  id="user-id"
                  name="user-id"
                  type="text"
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="customer" style = "display:none;">kh</option>
                  <option value="customer">nv</option>
                  <option value="admin">ql</option>
                </select>
                <span class="form-message"></span>
      ...
      <table id="product-table">
        ...
        <tbody class="product-table__list">
          <tr class="product-table__row product-table__row--clicked">
            <td>1</td>
            <td>test8</td>
            <td style = "display:none;">10000000</td>
            <td>9000000</td>
            <td>test@gmail.com</td>
            <td>09xxxxxxxx</td>
            <td>xxxxxx</td>
...
function initUserPage() {
  ...
  function renderUserList(listUser) {
    ...
    Array.from(tableRow).forEach((row) => {
      ...
      btnUpdate.addEventListener("click", () => {
        ...
        modal.querySelector(".modal-content").classList.remove("fade");
  ...
  btnSave.addEventListener("click", (e) => {
    ...
    Array.from(functionList).forEach((item) => {
      if (item.dataset.value === "update") {
        updateUser();
        resetValue();
      } else if (item.dataset.value === "newadd") {
        addUser();
        resetValue();
      }
    });
  ...
  btnCancel.addEventListener("click", (e) => {
    e.preventDefault();
    modal.querySelector(".modal-content").classList.add("fade");
    setTimeout(() => {
  ...
  function searchUser() {
    const searchID = document.querySelector("#maNV").value.trim();
    const searchName = document.querySelector("#tenNV").value.trim();
    const rows = $(".product-table__row");

    rows.forEach((row) => {
      const userID = row.cells[0].innerText.trim();
      const userName = row.cells[3].innerText.trim();

      const isMatchID = searchID === "" || userID.includes(searchID);
      const isMatchName =
        searchName === "" ||
